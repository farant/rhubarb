...
s32 principale (vacuum)
{
     ...
     * ======================================================== */
    {
        ...
        ev = _ev_runa((s32)'j');
        CREDO_VERUM (saltuarius_claves_tradere(&claves, SALT_MODUS_COLUMNAE, &ev,
            &iussum));
        ...
        /* runa ignota: nihil */
        ev = _ev_runa((s32)'z');
        CREDO_FALSUM (saltuarius_claves_tradere(&claves, SALT_MODUS_COLUMNAE, &ev,
            &iussum));
    }
     ...
     * ======================================================== */
    {
        ...
        ev = _ev_runa((s32)'g');
        (vacuum)saltuarius_claves_tradere(&claves, SALT_MODUS_COLUMNAE, &ev, &iussum);
        ev = _ev_runa((s32)'j');
        CREDO_VERUM (saltuarius_claves_tradere(&claves, SALT_MODUS_COLUMNAE, &ev,
            &iussum));
        CREDO_AEQUALIS_I32 ((i32)iussum.genus,
