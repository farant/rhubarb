...
s32 principale (vacuum)
{
    ...
    piscina = piscina_generare_dynamicum("probatio_imago_collatio",
        M * M);
    si (!piscina)
    {
    ...
    imprimere("\n--- IV. Mensurae discrepantes ---\n");
    {
        ...
        fructus = imago_conferre(&a, &b, collatio_regula_solita(),
            NIHIL);
    ...
    imprimere("\n--- V. Argumenta invalida ---\n");
    {
        ...
        fructus = imago_conferre(NIHIL, &a, collatio_regula_solita(),
            NIHIL);
        CREDO_AEQUALIS_S32((s32)fructus.sententia,
                           (s32)COLLATIO_ARGUMENTA_INVALIDA);

        fructus = imago_conferre(&a, NIHIL, collatio_regula_solita(),
            NIHIL);
        CREDO_AEQUALIS_S32((s32)fructus.sententia,
                           (s32)COLLATIO_ARGUMENTA_INVALIDA);
        ...
        vacua.latitudo  = IV;
        vacua.altitudo  = IV;
        fructus = imago_conferre(&vacua, &a, collatio_regula_solita(),
            NIHIL);
        CREDO_AEQUALIS_S32((s32)fructus.sententia,
                           (s32)COLLATIO_ARGUMENTA_INVALIDA);
    }
    ...
    imprimere("\n--- VII. Pictura ---\n");
    {
        ...
        CREDO_AEQUALIS_I32(_legere(&fructus.pictura, I, I, 0),
            (i32)CCLV);
        CREDO_AEQUALIS_I32(_legere(&fructus.pictura, I, I, (i32)I),
            ZEPHYRUM);
        CREDO_AEQUALIS_I32(_legere(&fructus.pictura, I, I, (i32)II),
            ZEPHYRUM);
        CREDO_AEQUALIS_I32(_legere(&fructus.pictura, I, I, (i32)III),
            (i32)CCLV);
        ...
        CREDO_AEQUALIS_I32(_legere(&fructus.pictura, 0, 0, (i32)III),
            (i32)CCLV);
