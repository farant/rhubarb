    ...
    void)
{
    ...
    dum (currens && !fenestra_debet_claudere(fenestra))
    {
        ...
        delineare_vacare(ctx, color_ex_rgb((i8)XXVI, (i8)XXVI,
            (i8)XLVI));

        /* Delineare formas varias */

        /* Circulus ruber */
        delineare_circulum(ctx, C, C, XL, color_ex_rgb((i8)CCLV,
            (i8)ZEPHYRUM, (i8)ZEPHYRUM));

        /* Circulus plenus viridis */
        delineare_circulum_plenum(ctx, CC, C, XXX,
            color_ex_rgb((i8)ZEPHYRUM, (i8)CCLV, (i8)ZEPHYRUM));

        /* Rectangulum caeruleus */
        delineare_rectangulum(ctx, CCC, L, C, LXX,
            color_ex_rgb((i8)ZEPHYRUM, (i8)ZEPHYRUM, (i8)CCLV));

        /* Rectangulum plenum flavus */
        delineare_rectangulum_plenum(ctx, CDLXXX, L, LXXX, LX,
            color_ex_rgb((i8)CCLV, (i8)CCLV, (i8)ZEPHYRUM));

        /* Linea alba */
        delineare_lineam(ctx, L, CC, DC, CCC, color_ex_rgb((i8)CCLV,
            (i8)CCLV, (i8)CCLV));

        /* Triangulum magenta */
        delineare_triangulum(ctx, puncta_trianguli[ZEPHYRUM],
            puncta_trianguli[I],
                                   puncta_trianguli[II],
                                   puncta_trianguli[III],
                                   puncta_trianguli[IV],
                                   puncta_trianguli[V],
                                   color_ex_rgb((i8)CCLV, (i8)ZEPHYRUM,
                                   (i8)CCLV));

        /* Triangulum plenum cyaneus */
        delineare_triangulum_plenum(ctx, CCC, CCC, CD, CCC, CCC, CDXX,
                                          color_ex_rgb((i8)ZEPHYRUM,
                                          (i8)CCLV, (i8)CCLV));

        /* Ellipsis aurantius */
        delineare_ellipsin(ctx, CD, CD, LX, XL, color_ex_rgb((i8)CCLV,
            (i8)CLXV, (i8)ZEPHYRUM));

        /* Ellipsis plena purpurea */
        delineare_ellipsin_plenam(ctx, DC, CD, XL, XXX,
            color_ex_rgb((i8)CXXX, (i8)L, (i8)CXXX));

        /* Polygonum albus */
        delineare_polygonum(ctx, puncta_polygoni, IV,
            color_ex_rgb((i8)CCLV, (i8)CCLV, (i8)CCLV));

        /* Polygonum plenum viridis obscurus */
        delineare_polygonum_plenum(ctx, puncta_polygoni, IV,
            color_ex_rgb((i8)ZEPHYRUM, (i8)C, (i8)ZEPHYRUM));
        ...
        delineare_rectangulum_plenum(ctx, DC, CDXX, LX, L,
            color_ex_rgb((i8)CCLV, (i8)CCLV, (i8)ZEPHYRUM));
        delineare_ponere_modum(ctx, MODUS_SOLIDUS);

        /* Pixela singularia rubra */
        delineare_pixelum(ctx, X, X, color_ex_rgb((i8)CCLV,
            (i8)ZEPHYRUM, (i8)ZEPHYRUM));
        delineare_pixelum(ctx, XII, X, color_ex_rgb((i8)CCLV,
            (i8)ZEPHYRUM, (i8)ZEPHYRUM));
        delineare_pixelum(ctx, X, XII, color_ex_rgb((i8)CCLV,
            (i8)ZEPHYRUM, (i8)ZEPHYRUM));
        delineare_pixelum(ctx, XII, XII, color_ex_rgb((i8)CCLV,
            (i8)ZEPHYRUM, (i8)ZEPHYRUM));

        /* Lineae horizontalis et verticalis */
        delineare_lineam_horizontalem(ctx, DCC, DCCL, XXX,
            color_ex_rgb((i8)ZEPHYRUM, (i8)CCLV, (i8)CCLV));
        delineare_lineam_verticalem(ctx, DCCL, XXX, LXX,
            color_ex_rgb((i8)CCLV, (i8)ZEPHYRUM, (i8)CCLV));

        /* Crates griseus */
        delineare_cratem(ctx, L, color_ex_rgb((i8)LXIV, (i8)LXIV,
            (i8)LXIV));

        /* Pingere textum */
        textus =
            chorda_ex_literis("Probatio Delineare\n\nPremere EFFUGIUM ut claudas.",
            piscina);
        ...
        tabula_pixelorum_pingere_chordam_scalatam(tabula, CCC, CD,
            textus,
            color_ad_pixelum(color_ex_rgb((i8)CCLV, (i8)C, (i8)CCLV)),
            IV);
