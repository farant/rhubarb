    ...
    i32  mensura)
{
    ...
    constans character* verba[] = {
        ...
        "which ", "one ", "you ", "were ", "her ", "all ", "she ",
            "there ", "would ", "their ",
        "we ", "him ", "been ", "has ", "when ", "who ", "will ",
            "more ", "no ", "if ",
        "out ", "so ", "said ", "what ", "up ", "its ", "about ",
            "into ", "than ", "them ",
        "can ", "only ", "other ", "new ", "some ", "could ", "time ",
            "very ", "these ", "may ",
        "just ", "any ", "know ", "see ", "now ", "way ", "made ",
            "after ", "most ", "also ",
        "did ", "many ", "before ", "must ", "through ", "back ",
            "years ", "where ", "much ", "your ",
        "well ", "down ", "should ", "because ", "each ", "people ",
            "Mr ", "how ", "long ", "little ",
        "world ", "like ", "still ", "own ", "never ", "such ", "here ",
            "last ", "between ", "under "
    };
           ...
           constans character* titulus)
{
    ...
    piscina = piscina_generare_dynamicum("benchmark",
        (memoriae_index)(mensura * III));
    ...
    character** argv)
{
    ...
    printf("  %-12s %6s    %10s %8s  %7s  %10s\n",
           "Nivellus", "Input", "Output", "Ratio", "Tempus",
           "Throughput");
    printf("  %-12s %6s    %10s %8s  %7s  %10s\n",
           "--------", "-----", "------", "-----", "------",
           "----------");
    ...
    currere_benchmark(megabytes, FLATURA_COMPRESSIO_RAPIDA,
        "RAPIDA");
    currere_benchmark(megabytes, FLATURA_COMPRESSIO_ORDINARIA,
        "ORDINARIA");
    currere_benchmark(megabytes, FLATURA_COMPRESSIO_OPTIMA,
        "OPTIMA");
