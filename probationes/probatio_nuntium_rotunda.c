...
s32 principale(vacuum)
{
...

    {
        ...
        CREDO_VERUM(chorda_aequalis(*lecta->appellatio,
            *originale.appellatio));
...

    {
        ...
        CREDO_VERUM(chorda_aequalis_literis(*lecta_a->appellatio,
            "Gaius"));
        ...
        CREDO_VERUM(chorda_aequalis_literis(*lecta_b->appellatio,
            "Titus"));
