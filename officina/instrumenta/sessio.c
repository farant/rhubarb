...
interior s32
_turnum_possidentem (
    constans TurnusVisus* visus,
                     i32  numerus,
                     i32  linea_involuta,
                     i32* linea_ostensa_out)
{
    i32 k;
...
interior i32
_numerare_generis_valoris (
    SilvaValor v,
       integer genus);

interior i32
_numerare_generis_nodi (
    constans SilvaNodus* n,
                integer  genus)
{
                   i32 summa = ZEPHYRUM;
...
_mundum_aedificare (
            Sessio* s,
    MedullaModulus* modulus_documenti)
{
    i32 k;
...
sessio_creare (
                        Piscina* piscina,
    constans SessioConfiguratio* cfg)
{
    Sessio* s;
...
_visum_construere (
    ...
    Piscina* piscina,
     chorda  candidatus,
        s32  genus_candidati,
     chorda  involucrum_candidati,
     chorda  typus_candidati,
        s32  index_substituti,
        i32* numerus_out,
        i32* index_novi_out)
{
            i32  n      = xar_numerus(s->turni);
