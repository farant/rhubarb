/* excludenda_generata.h - GENERATUM (messis compilatoris) - NE MANU EDITES
 *
 * Functiones vendicatae inusitatae (officina): punctum fixum
 * admonitionum unused-function sub severitate plena. Functio nova
 * consumpta = regenerare (introitus sponte cadit); ne manu dele.
