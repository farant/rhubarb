 ...
 * loci_numerus nominat. Genera XXI, loci XLV.
 */
...
hic_manens constans MateriaTabLocus LOCI_COCTI[] = {
    ...
    /* declaratio-mala (23..23) */
    { "tokens", (s32)MATERIA_LOCUS_LISTA_TOKEN },

    /* selector-lista (24..24) */
    ...
    /* selector-compositus (28..28) */
    { "partes", (s32)MATERIA_LOCUS_LISTA_NODUS },

    /* selector-typi (29..29) */
    { "tok", (s32)MATERIA_LOCUS_TOKEN },

    /* selector-universalis (30..30) */
    { "tok", (s32)MATERIA_LOCUS_TOKEN },
