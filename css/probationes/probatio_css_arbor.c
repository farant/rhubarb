...
hic_manens constans LocusNominatus LOCI_NOMINATI[] = {
    ...
    { (s32)CSS_GENUS_SELECTOR_COMPLEXUS,
      (i32)CSS_COMPLEXUS_SINISTER,           "sinister" },
    { (s32)CSS_GENUS_SELECTOR_COMPLEXUS,
      (i32)CSS_COMPLEXUS_COMBINATOR,         "combinator" },
    { (s32)CSS_GENUS_SELECTOR_COMPLEXUS,
      (i32)CSS_COMPLEXUS_DEXTER,             "dexter" },
    { (s32)CSS_GENUS_SELECTOR_COMPOSITUS,
      (i32)CSS_COMPOSITUS_PARTES,            "partes" },
    { (s32)CSS_GENUS_SELECTOR_TYPI,
      (i32)CSS_TYPI_TOK,                     "tok" },
    { (s32)CSS_GENUS_SELECTOR_UNIVERSALIS,
      (i32)CSS_UNIVERSALIS_TOK,              "tok" },
    { (s32)CSS_GENUS_SELECTOR_CLASSIS,
      (i32)CSS_CLASSIS_TOK_PUNCTUM,          "tok_punctum" },
    { (s32)CSS_GENUS_SELECTOR_CLASSIS,
      (i32)CSS_CLASSIS_TOK_NOMEN,            "tok_nomen" },
    { (s32)CSS_GENUS_SELECTOR_IDENTITATIS,
      (i32)CSS_IDENTITATIS_TOK,              "tok" },
    { (s32)CSS_GENUS_SELECTOR_ATTRIBUTI,
      (i32)CSS_ATTRIBUTI_TOK_APERTUM,        "tok_apertum" },
    { (s32)CSS_GENUS_SELECTOR_ATTRIBUTI,
      (i32)CSS_ATTRIBUTI_TOK_NOMEN,          "tok_nomen" },
    { (s32)CSS_GENUS_SELECTOR_ATTRIBUTI,
      (i32)CSS_ATTRIBUTI_TOK_OPERATOR,       "tok_operator" },
    { (s32)CSS_GENUS_SELECTOR_ATTRIBUTI,
      (i32)CSS_ATTRIBUTI_VALOR,              "valor" },
    { (s32)CSS_GENUS_SELECTOR_ATTRIBUTI,
      (i32)CSS_ATTRIBUTI_TOK_CLAUSUM,        "tok_clausum" },
    { (s32)CSS_GENUS_PSEUDO_CLASSIS,
      (i32)CSS_PSEUDO_CLASSIS_TOK_COLON,     "tok_colon" },
    { (s32)CSS_GENUS_PSEUDO_CLASSIS,
      (i32)CSS_PSEUDO_CLASSIS_TOK_NOMEN,     "tok_nomen" },
    { (s32)CSS_GENUS_PSEUDO_CLASSIS,
      (i32)CSS_PSEUDO_CLASSIS_ARGUMENTA,     "argumenta" },
    { (s32)CSS_GENUS_PSEUDO_ELEMENTUM,
      (i32)CSS_PSEUDO_ELEMENTI_TOK_COLON,    "tok_colon" },
    { (s32)CSS_GENUS_PSEUDO_ELEMENTUM,
      (i32)CSS_PSEUDO_ELEMENTI_TOK_NOMEN,    "tok_nomen" },
    { (s32)CSS_GENUS_SELECTOR_MALUS,
      (i32)CSS_MALUM_TOKENS,                 "tokens" }
};
