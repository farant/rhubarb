/* computus.c - CLI computi CSS: ./css/computus.sh <plagula.css>
    ...
    character** argumenta)
{
    ...
    piscina = piscina_generare_dynamicum("css_computus",
        MMMMXCVI * CCLVI);
    si (piscina == NIHIL)
    {
    ...
    {
        sana = css_computus_metiri((constans character*)fons, mensura,
            &c);
    }
    si (machina)
    {
