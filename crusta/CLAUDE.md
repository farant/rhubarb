...
- **Gates (15, `./crusta/compile_probationes.sh`, every one born red by
  ...
  | diagnostica | declared shapes vs the four counters, class by class: house 235, oracle 121, adversarial 17, 16 inline shapes, plus every fuzz case | VACUA counted as a closure; `malum`'s `inanis` removed |
