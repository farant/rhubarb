 ...
 * tabulae (CLXXVI ordines, ex declaratione generati; P6 duo
 * addidit: iteratio.interiecta, electio.interiecta, et separator
 * iterationis/cycli lista facta; P9b XXIV: listae post_* lacunarum
 * expressionis et functio.interiecta). */
nomen structura {
                    s32  genus;
                    i32  locus;
...
hic_manens constans LocusNominatus LOCI_NOMINATI[] = {
    ...
    { (s32)CRUSTA_GENUS_FUNCTIO,
        (i32)CRUSTA_FUNCTIO_INTERIECTA, "interiecta" },
    { (s32)CRUSTA_GENUS_FUNCTIO,
    ...
    { (s32)CRUSTA_GENUS_ARITHMETICA,
        (i32)CRUSTA_ARITHMETICA_POST_APERTURAM, "post_aperturam" },
    { (s32)CRUSTA_GENUS_ARITHMETICA,
        (i32)CRUSTA_ARITHMETICA_EXPRESSIO, "expressio" },
    { (s32)CRUSTA_GENUS_ARITHMETICA,
        (i32)CRUSTA_ARITHMETICA_POST_EXPRESSIONEM,
            "post_expressionem" },
    { (s32)CRUSTA_GENUS_ARITHMETICA,
    ...
    { (s32)CRUSTA_GENUS_IUDICIUM,
        (i32)CRUSTA_IUDICIUM_POST_APERTURAM, "post_aperturam" },
    { (s32)CRUSTA_GENUS_IUDICIUM,
        (i32)CRUSTA_IUDICIUM_EXPRESSIO, "expressio" },
    { (s32)CRUSTA_GENUS_IUDICIUM,
        (i32)CRUSTA_IUDICIUM_POST_EXPRESSIONEM, "post_expressionem" },
    { (s32)CRUSTA_GENUS_IUDICIUM,
    ...
    { (s32)CRUSTA_GENUS_PARS_ARITHMETICA,
        (i32)CRUSTA_PARS_ARITHMETICA_POST_APERTURAM, "post_aperturam" },
    { (s32)CRUSTA_GENUS_PARS_ARITHMETICA,
        (i32)CRUSTA_PARS_ARITHMETICA_EXPRESSIO, "expressio" },
    { (s32)CRUSTA_GENUS_PARS_ARITHMETICA,
        (i32)CRUSTA_PARS_ARITHMETICA_POST_EXPRESSIONEM,
            "post_expressionem" },
    { (s32)CRUSTA_GENUS_PARS_ARITHMETICA,
