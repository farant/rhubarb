...
/* arithmetica et iudicium: forma eadem; post_* = corpora heredoc in
 * lacunis (P9b) */
nomen enumeratio {
    CRUSTA_ARITHMETICA_TOK_APERTURA = 0,
    CRUSTA_ARITHMETICA_POST_APERTURAM, CRUSTA_ARITHMETICA_EXPRESSIO,
    CRUSTA_ARITHMETICA_POST_EXPRESSIONEM,
    CRUSTA_ARITHMETICA_TOK_CLAUSURA, CRUSTA_ARITHMETICA_REDIRECTIONES
} CrustaArithmeticaLocus;
nomen enumeratio {
    CRUSTA_IUDICIUM_TOK_APERTURA = 0, CRUSTA_IUDICIUM_POST_APERTURAM,
    CRUSTA_IUDICIUM_EXPRESSIO, CRUSTA_IUDICIUM_POST_EXPRESSIONEM,
...
nomen enumeratio {
    ...
    CRUSTA_PARS_ARITHMETICA_POST_APERTURAM,
    CRUSTA_PARS_ARITHMETICA_EXPRESSIO,
    CRUSTA_PARS_ARITHMETICA_POST_EXPRESSIONEM,
...
nomen enumeratio {
    CRUSTA_PRAEPOSITA_TOK_OPERATOR = 0, CRUSTA_PRAEPOSITA_POST_SIGNUM,
    CRUSTA_PRAEPOSITA_OPERANDUM
} CrustaPraepositaLocus;
nomen enumeratio {
    CRUSTA_POSTPOSITA_OPERANDUM = 0, CRUSTA_POSTPOSITA_POST_OPERANDUM,
    CRUSTA_POSTPOSITA_TOK_OPERATOR
} CrustaPostpositaLocus;
/* binaria, iudicium-binaria, iudicium-coniuncta */
nomen enumeratio {
    CRUSTA_BINARIA_SINISTER = 0, CRUSTA_BINARIA_POST_SINISTRUM,
    CRUSTA_BINARIA_TOK_OPERATOR, CRUSTA_BINARIA_POST_SIGNUM,
    CRUSTA_BINARIA_DEXTER
} CrustaBinariaLocus;
nomen enumeratio {
    CRUSTA_TERNARIA_PROBATIO = 0, CRUSTA_TERNARIA_POST_PROBATIONEM,
    CRUSTA_TERNARIA_TOK_QUAESTIO, CRUSTA_TERNARIA_POST_QUAESTIONEM,
    CRUSTA_TERNARIA_SINISTER, CRUSTA_TERNARIA_POST_SINISTRUM,
    CRUSTA_TERNARIA_TOK_COLON, CRUSTA_TERNARIA_POST_COLON,
    CRUSTA_TERNARIA_DEXTER
} CrustaTernariaLocus;
/* inclusa et iudicium-inclusa */
nomen enumeratio {
    CRUSTA_INCLUSA_TOK_APERTURA = 0, CRUSTA_INCLUSA_POST_APERTURAM,
    CRUSTA_INCLUSA_EXPRESSIO, CRUSTA_INCLUSA_POST_EXPRESSIONEM,
