...
nomen enumeratio {
    ...
    CRUSTA_ITERATIO_TOK_IN, CRUSTA_ITERATIO_VERBA,
    CRUSTA_ITERATIO_TOK_SEPARATOR, CRUSTA_ITERATIO_CURSUS,
    CRUSTA_ITERATIO_REDIRECTIONES
} CrustaIteratioLocus;
nomen enumeratio {
...
nomen enumeratio {
    ...
    CRUSTA_ELECTIO_TOK_IN, CRUSTA_ELECTIO_LIBERI,
    CRUSTA_ELECTIO_TOK_CLAUSURA, CRUSTA_ELECTIO_REDIRECTIONES
} CrustaElectioLocus;
nomen enumeratio {
