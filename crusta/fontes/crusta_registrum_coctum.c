...
hic_manens constans MateriaTabDiagnosticum DIAGNOSTICA_COCTA[] = {
    ...
    { (s32)CRUSTA_GENUS_MALUM, (s32)-1,
      (s32)MATERIA_DIAGNOSTICUM_GENUS,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "malum",
      "lexemata quae grammatica ponere non potuit" },
    { (s32)CRUSTA_GENUS_HEREDOC, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_MONITUM,
      "heredoc/tok_delimitator",
      "heredoc sine delimitatore ad finem" },
    { (s32)CRUSTA_GENUS_TABULATUM, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "tabulatum/tok_clausura",
      "')' exspectata" },
    { (s32)CRUSTA_GENUS_FUNCTIO, (s32)5,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "functio/corpus",
      "corpus functionis exspectatum" },
    { (s32)CRUSTA_GENUS_GREX, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "grex/liberi",
      "lista mandatorum vacua" },
    { (s32)CRUSTA_GENUS_GREX, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "grex/tok_clausura",
      "'}' exspectata" },
    { (s32)CRUSTA_GENUS_CRUSTULA, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "crustula/liberi",
      "lista mandatorum vacua" },
    { (s32)CRUSTA_GENUS_CRUSTULA, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "crustula/tok_clausura",
      "')' exspectata" },
    { (s32)CRUSTA_GENUS_CONDITIO, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "conditio/probatio",
      "probatio vacua" },
    { (s32)CRUSTA_GENUS_CONDITIO, (s32)3,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "conditio/liberi",
      "lista mandatorum vacua" },
    { (s32)CRUSTA_GENUS_CONDITIO, (s32)5,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "conditio/tok_clausura",
      "'fi' exspectatum" },
    { (s32)CRUSTA_GENUS_RAMUS, (s32)3,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "ramus/liberi",
      "lista mandatorum vacua" },
    { (s32)CRUSTA_GENUS_ITERATIO, (s32)6,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "iteratio/cursus",
      "'do ... done' exspectatum" },
    { (s32)CRUSTA_GENUS_CYCLUS, (s32)5,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "cyclus/cursus",
      "'do ... done' exspectatum" },
    { (s32)CRUSTA_GENUS_REPETITIO, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "repetitio/probatio",
      "probatio vacua" },
    { (s32)CRUSTA_GENUS_REPETITIO, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "repetitio/cursus",
      "'do ... done' exspectatum" },
    { (s32)CRUSTA_GENUS_CURSUS, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_VACUA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "cursus/liberi",
      "lista mandatorum vacua" },
    { (s32)CRUSTA_GENUS_CURSUS, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "cursus/tok_clausura",
      "'done' exspectatum" },
    { (s32)CRUSTA_GENUS_ELECTIO, (s32)5,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "electio/tok_clausura",
      "'esac' exspectatum" },
    { (s32)CRUSTA_GENUS_OPTIO, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "optio/tok_parenthesis_clausura",
      "')' exemplaris exspectata" },
    { (s32)CRUSTA_GENUS_ARITHMETICA, (s32)4,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "arithmetica/tok_clausura",
      "'))' exspectatum" },
    { (s32)CRUSTA_GENUS_IUDICIUM, (s32)4,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "iudicium/tok_clausura",
      "']]' exspectatum" },
    { (s32)CRUSTA_GENUS_SOCIUS, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "socius/imperium",
      "imperium coprocessus exspectatum" },
    { (s32)CRUSTA_GENUS_PARS_GEMINA, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-gemina/tok_clausura",
      "apex geminus exspectatus" },
    { (s32)CRUSTA_GENUS_PARS_VERSA, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-versa/tok_clausura",
      "'`' exspectatum" },
    { (s32)CRUSTA_GENUS_PARS_PARAMETRUM, (s32)1,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-parametrum/tok_titulus",
      "titulus parametri exspectatus" },
    { (s32)CRUSTA_GENUS_PARS_EXPANSIO, (s32)6,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-expansio/tok_clausura",
      "'}' exspectata" },
    { (s32)CRUSTA_GENUS_PARS_SUBSTITUTIO, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-substitutio/tok_clausura",
      "')' exspectata" },
    { (s32)CRUSTA_GENUS_PARS_ARITHMETICA, (s32)4,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-arithmetica/tok_clausura",
      "'))' exspectatum" },
    { (s32)CRUSTA_GENUS_PARS_PROCESSUS, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "pars-processus/tok_clausura",
      "')' exspectata" },
    { (s32)CRUSTA_GENUS_BINARIA, (s32)0,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_MONITUM,
      "binaria/sinister",
      "operandum exspectatum" },
    { (s32)CRUSTA_GENUS_BINARIA, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_MONITUM,
      "binaria/tok_operator",
      "operator arithmeticus exspectatus" },
    { (s32)CRUSTA_GENUS_BINARIA, (s32)4,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_MONITUM,
      "binaria/dexter",
      "operandum exspectatum" },
    { (s32)CRUSTA_GENUS_INCLUSA, (s32)4,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "inclusa/tok_clausura",
      "')' exspectata" },
    { (s32)CRUSTA_GENUS_IUDICIUM_BINARIA, (s32)2,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_MONITUM,
      "iudicium-binaria/tok_operator",
      "operator condicionis exspectatus" },
    { (s32)CRUSTA_GENUS_IUDICIUM_INCLUSA, (s32)4,
      (s32)MATERIA_DIAGNOSTICUM_ABSENTIA,
      (s32)MATERIA_GRAVITAS_ERRATUM,
      "iudicium-inclusa/tok_clausura",
      "')' exspectata" },
};
...
constans MateriaDiagnosticaCocta CRUSTA_DIAGNOSTICA = {
    DIAGNOSTICA_COCTA,
