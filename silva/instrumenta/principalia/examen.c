...
#include "silva_lexicon.h"   /* derivatio + bloci externa (modulus
                              ...
                              * migrant, ne quartus geminus oriatur) */
#include <stdio.h>
#include <string.h>
...
s32 principale (integer argc, character** argv)
{
     ...
     * ante compositionem lexici excerpere oportet. (Verbum nudum
     * sine uncis CONSULTO - sequentia aperiens tagi excerptorem in
     * hanc ipsam plagulam falleret; vide silva_lexicon.c CAVE.) */
