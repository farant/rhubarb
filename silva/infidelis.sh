...
# silva/infidelis.sh - diagnosticum plagulae UNIUS: errores cum
# lineis + fragmentis, deinde fidelitas (prima divergentia octetim
# vel causa fracturae scripturae)
#
# Usage:
#   ./silva/infidelis.sh <via> [-nudus]
...
source "$SILVA_DIR/infidelis_fontes_generata.sh"
...
ARBOR_SRC="$SILVA_DIR/instrumenta/principalia/infidelis.c"
ARBOR_BIN="$BUILD_DIR/infidelis"
