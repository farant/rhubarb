...
hic_manens constans i8 palette_aquinas[XLVIII] = {
    ...
    0x1F, 0x17, 0x1F,  /* 2: Medium dark gray (mauve) */
...
thema_color_ex_indice_colorationis(i8 index)
{
     ...
     * COLORATIO_TYPUS       = 12 -> PALETTE_BRIGHT_LEAF (type colons)
     */
    ...
    commutatio (index)
    {
        ...
        casus XII: /* COLORATIO_TYPUS */
            redde color_ex_palette(PALETTE_BRIGHT_LEAF);
