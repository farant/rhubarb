...
hic_manens constans Arbor2TabulaActio STATUS_6_ACTIONES[] = {
    ...
    /* Struct/union/enum for casts - Part 2, state 422+ (not yet implemented) */
};
...
/* States 358-363: after 'specifier type declarator' - reduce */
/* State 358: reduce P148 (static) */
...
/* State 360: reduce P150 (register) */
...
/* State 363: reduce P153 (volatile) */
...
/* State 389: after 'sizeof ( int' - expects ')' or '*' */
...
/* State 390: after 'sizeof ( char' - expects ')' or '*' */
...
/* State 391: after 'sizeof ( void' - expects ')' or '*' */
...
/* State 395: after 'sizeof ( int *' - expects ')' or '*' */
...
/* State 396: after 'sizeof ( char *' - expects ')' or '*' */
...
/* State 397: after 'sizeof ( void *' - expects ')' or '*' */
...
/* State 416: after 'sizeof ( ID' - expects ')' or '*' */
...
/* State 418: after 'sizeof ( ID *' - expects ')' or '*' */
