...
/* State 565: after 'sizeof ( int [ expr ]' - expects ')' */
...
/* State 569: after 'sizeof ( char [ expr ]' - expects ')' */
...
/* State 573: after 'sizeof ( void [ expr ]' - expects ')' */
...
/* State 577: after 'sizeof ( ID [ expr ]' - expects ')' */
