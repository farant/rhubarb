...
/* Superficies socketorum (sys/socket.h, netinet/in.h,
 * arpa/inet.h, netdb.h) olim hic ut bloci externa stabant
 * (iudici soli, formae ex SDK verbatim); 2026-07-27 in
 * silva/fontes/systema_posix.h promotae et per auspex_posix
 * certificatae (01KYB2Z7XA - etiam ordo Darwin addrinfo:
 * ai_canonname ANTE ai_addr). Derivatio ex inclusionibus eas
 * nunc sponte praebet. */
