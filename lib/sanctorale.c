...
interior constans SanctoraleDatum SANCTORALE[] = {
    ...
    { FASTI_IANUARIUS, VI,
      ...
      GRADUS_SOLLEMNITAS, COLOR_ALBUS, FALSUM },
    ...
    { FASTI_IANUARIUS, XX,
      ...
      GRADUS_MEMORIA_AD_LIBITUM, COLOR_RUBER, FALSUM },
    ...
    { FASTI_IANUARIUS, XXI,
      ...
      GRADUS_MEMORIA, COLOR_RUBER, FALSUM },
    ...
    { FASTI_IANUARIUS, XXV,
      ...
      GRADUS_FESTUM, COLOR_ALBUS, FALSUM },
    ...
    { FASTI_APRILIS, XXV,
      ...
      GRADUS_FESTUM, COLOR_RUBER, FALSUM },
    ...
    { FASTI_IUNIUS, XXIX,
      ...
      GRADUS_SOLLEMNITAS, COLOR_RUBER, FALSUM },
    ...
    { FASTI_NOVEMBER, II,
      ...
      GRADUS_DIES_PECULIARIS, COLOR_VIOLACEUS, FALSUM },
