...
for o in piscina chorda chorda_aedificator xar friatio tabula_dispersa internamentum utf8 json similitudo sigillum scrinium tabellarius gesta tabularium; do
