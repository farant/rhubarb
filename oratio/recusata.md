...
| R19 | T32 c | contest judge from the pair table (`ORATIO_IUDEX=1`, `fixa/contentiones.tsv`) | 500/20: Seneca attachment +4, charters −9/−9, case −4/−2/−1; 800/30: right arcs +9..+79 everywhere but charters attachment −5/−5, Dante −2, case −3/−3/−2, forced −2/−6/−4 | oraculum (the arc census cannot see reading contests on one arc) + exsecutor | retractandum with a case-aware contest census (loser's and winner's reading vs the partner's gold case) |
