#!/bin/bash
# oratio/sententiae.sh - sententiae plagulae orationis: una per lineam, extenta octetim
#
# Usage:  ./oratio/sententiae.sh <plagula.txt> [-machina]
# Exit:   0 sanum | 1 fractum | 2 usus/plagula absens
# Obiecta oratio/build/*.o poscit (cursor oratio/compile_probationes.sh ea
# struit); instrumentum in oratio/build/sententiae.
set -u
