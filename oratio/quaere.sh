#!/bin/bash
# oratio/quaere.sh - quaesitio Latina in tabula WORDS: analyses formae (T8)
#
# Usage:  ./oratio/quaere.sh [-machina] forma...
# Exit:   0 sanum | 1 fractum | 2 usus/plagula absens
# Obiecta oratio/build/*.o poscit (cursor oratio/compile_probationes.sh ea
# struit); instrumentum in oratio/build/quaere.
set -u
