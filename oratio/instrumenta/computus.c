/* computus.c - CLI computi orationis: ./oratio/computus.sh <plagula.txt>
    ...
    character** argumenta)
{
    ...
    piscina = piscina_generare_dynamicum("oratio_computus",
        MMMMXCVI * CCLVI);
    si (piscina == NIHIL)
    {
    ...
    {
        sana = oratio_computus_metiri((constans character*)fons,
            mensura,
            &c);
    }
    si (machina)
