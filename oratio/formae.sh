#!/bin/bash
# oratio/formae.sh - forma paragraphi cuiusque cum regula et indiciis (T6b)
#
# Usage:  ./oratio/formae.sh <plagula.txt> [-machina]
# Exit:   0 sanum | 1 fractum | 2 usus/plagula absens
# Obiecta oratio/build/*.o poscit (cursor oratio/compile_probationes.sh ea
# struit); instrumentum in oratio/build/formae.
set -u
