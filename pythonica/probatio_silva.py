...
credo(len(aa) == 3 and a.classis == 'substantivum' and a.lemma == 'puella' and a.lingua == 'latina' and a.fons == 'vocabularium-la' and a.nativum == 'N 1 1 ABL S C' and a.sensus.startswith('girl') and a.index == 0, 'Oratio.analyses: classis, lemma, lingua, fons, nativum, sensus (T24: prior casuum verbo aperto ablativum primum ponit)')
