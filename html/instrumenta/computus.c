/* computus.c - CLI computi HTML: ./html/computus.sh <plagula.html>
...
_imprimere_hominem (
       constans character* via,
    constans HtmlComputus* c)
{
    imprimere("computus html %s\n", via);
    ...
    character** argumenta)
{
    ...
    {
        fprintf(stderr,
            "usus: computus <plagula.html> [-machina] [-iter N]\n"
    ...
    {
        sana = html_computus_metiri((constans character*)fons, mensura,
            &c);
    }
    si (machina)
    {
