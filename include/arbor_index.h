...
vacuum
arbor_index_addere_filum (
        ArborProiectum* proj,
    constans character* via);

/* Addere folder (cum glob pattern) */
vacuum
arbor_index_addere_folder (
        ArborProiectum* proj,
    constans character* via,
...
ArborIndexSymbolum*
arbor_index_symbolum_ad_punctum (
        ArborProiectum* proj,
    constans character* via,
                   i32  linea,
                   i32  columna);
