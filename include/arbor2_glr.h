...
constans character*
arbor2_actio_genus_nomen (
    Arbor2ActioGenus genus);
...
vacuum
arbor2_glr_initializare_tabulas (
    Arbor2GLR* glr);
...
Arbor2Regula*
arbor2_tabula_obtinere_regula (
    i32 index);

/* Get state info (for new array-of-arrays structure) */
constans Arbor2StatusInfo*
arbor2_tabula_obtinere_status_info (
    i32 status);
...
chorda*
arbor2_glr_exspectata_pro_statu (
    Piscina* piscina,
        s32  status);
...
#define ARBOR2_TAG_ENUMERATOR_INIT_CONTEXTUS 0x0400  /* Enum constant expression context */
#define ARBOR2_TAG_CASE_EXPR_CONTEXTUS 0x0800  /* Case constant expression context */
