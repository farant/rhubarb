/* computus.c - CLI computi markdown: ./briar/computus.sh <plagula.md>
    ...
    character** argumenta)
{
    ...
    piscina = piscina_generare_dynamicum("briar_computus",
        MMMMXCVI * CCLVI);
    si (piscina == NIHIL)
    {
    ...
    {
        sana = briar_computus_metiri((constans character*)fons, mensura,
            &c);
    }
    si (machina)
    {
