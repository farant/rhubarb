/* md_computus.c - vide md_computus.h (gemellus css_computus.c) */
            ...
            MdComputus* exitus)
{
    ...
    piscina = piscina_generare_dynamicum("md_computus_parsare",
        MD_COMPUTUS_ALVEUS_INITIUM);
    si (piscina == NIHIL)
    {
        redde FALSUM;
    }
    ...
    _numerare(radix, &exitus->nodi, &exitus->lexemata);
    {
        ...
        altera = piscina_generare_dynamicum("md_computus_arbor",
            MD_COMPUTUS_ALVEUS_INITIUM);
        si (altera == NIHIL)
        {
            piscina_destruere(piscina);
        ...
        si (materia_lexicon_ratum_facere(&ratum, &MD_LEXICON,
            &iudicium))
        {
